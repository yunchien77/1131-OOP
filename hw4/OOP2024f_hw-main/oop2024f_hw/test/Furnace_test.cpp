...
TEST(FURNACE_SYSTEM_TEST, Furnace_mix_02) {
    ...
    ASSERT_THROW(furnace.AddIronOre(std::make_shared<IronOre>()),
    ...
    ASSERT_THROW(furnace.AddGoldOre(std::make_shared<GoldOre>()),
                 std::invalid_argument);
...
//     furnace.AddOre(std::make_shared<IronOre>());
//     ASSERT_THROW(furnace.AddAnyOre(std::make_shared<GoldOre>()),
//                  std::invalid_argument);
//     furnace.AddOre(std::make_shared<IronOre>());
...
//     furnace.AddOre(std::make_shared<GoldOre>());
//     furnace.AddOre(std::make_shared<GoldOre>());
//     ASSERT_THROW(furnace.AddAnyOre(std::make_shared<DiamondOre>()),
//                  std::invalid_argument);
// }
// #endif