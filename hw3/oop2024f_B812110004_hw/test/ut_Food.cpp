...
TEST(MAINDISH_TEST,
     check_maindish_should_throw_invalid_argument_for_additional_food) {
    MainDish mainDish(Production::FishBurger);
    std::vector<Ingredients> addition = {Ingredients::Lattuce,
                                         Ingredients::Caramel};
...
TEST(MAINDISH_TEST,
     check_maindish_should_throw_invalid_argument_for_additional_food_two) {
    MainDish mainDish(Production::FishBurger);
    std::vector<Ingredients> addition = {
        Ingredients::Cola,    Ingredients::Caramel, Ingredients::ChickenNugget,
        Ingredients::Lattuce, Ingredients::Milk,    Ingredients::Milktea,
        Ingredients::Spirit,
    };
...
TEST(MAINDISH_TEST,
     check_maindish_should_have_correct_money_after_get_addtional_food) {
    MainDish mainDish(Production::FishBurger);
    std::vector<Ingredients> addition = {Ingredients::Lattuce,
...
TEST(MAINDISH_TEST,
     check_maindish_should_have_correct_money_after_get_addtional_food_two) {
    MainDish mainDish(Production::FishBurger);
    std::vector<Ingredients> addition = {
        Ingredients::Lattuce,
        Ingredients::FishSteak,
